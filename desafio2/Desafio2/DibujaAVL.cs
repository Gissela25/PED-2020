...
namespace Desafio2
{
    class DibujaAVL
    {
        ...
        //RECORRIDOS
        private void visitar(AVL rama, ref String cadena)
        {
        ...
        private string preorden2(AVL rama, ref string cadena)
        {
            if (rama != null)
            {
                visitar(rama, ref cadena);

                preorden2(rama.NodoIzquierdo, ref cadena);
                preorden2(rama.NodoDerecho, ref cadena);
            }
        ...
        private string postorden2(AVL rama, ref string cadena)
        {
            if (rama != null)
            {
                postorden2(rama.NodoIzquierdo, ref cadena);
                postorden2(rama.NodoDerecho, ref cadena);
                visitar(rama, ref cadena);
            }
