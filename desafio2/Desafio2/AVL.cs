...
namespace Desafio2
{
    class AVL
    {
        ...
        //FUNCION DE PRUEBA PARA REALIZAR
        ...
        //Dibuja las ramas de los nodos izq y derecho
        ...
        //Dibuja el nodo de la posicion especificada
        public void DibujarNodo(Graphics grafo, Font fuente, Brush Relleno, Brush RellenoFuente, Pen Lapiz, int dato, Brush encuentro)
        {
            ...
            //Dibuja los nodos hijos derecho e izq.
            if (NodoIzquierdo != null)
            {
